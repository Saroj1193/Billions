...
public enum CustomeTimingFunction {
    case linear
    case easeIn
    case easeOut
...
public enum CustomeRippleLocation {
    case center
    case left
    case right
    case tapLocation
...
open class CustomeLayer {
    ...
    // MARK - Animation
    open func animateScaleForCircleLayer(_ fromScale: Float, toScale: Float, timingFunction: CustomeTimingFunction, duration: CFTimeInterval) {
    ...
    open func animateAlphaForBackgroundLayer(_ timingFunction: CustomeTimingFunction, duration: CFTimeInterval) {
    ...
    open func animateSuperLayerShadow(_ fromRadius: CGFloat, toRadius: CGFloat, fromOpacity: Float, toOpacity: Float, timingFunction: CustomeTimingFunction, duration: CFTimeInterval) {
    ...
    fileprivate func animateShadowForLayer(_ layer: CALayer, fromRadius: CGFloat, toRadius: CGFloat, fromOpacity: Float, toOpacity: Float, timingFunction: CustomeTimingFunction, duration: CFTimeInterval) {
