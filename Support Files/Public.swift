...
func timeAgoChatList(_ date: Date) -> String {
...
func getTimestampToDate(_ createdAt: Int) -> Date {
...
func setOnlineStatus()  {
    ...
    Firestore.firestore().collection(usersCollection).document(currentUID).updateData(["OnlineStatus" : statusOnline])
}
